...
CREATE TABLE `queue` (
	...
	`dm_on_pull_toggle` integer DEFAULT true NOT NULL,
	`buttons_toggles` text DEFAULT 'all' NOT NULL,
	`header` text,
...
CREATE UNIQUE INDEX `prioritized_queue_id_subject_id_unique` ON `prioritized` (`queue_id`,`subject_id`);--> statement-breakpoint
