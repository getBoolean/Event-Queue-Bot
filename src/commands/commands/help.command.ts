			...
			embeds: [
				new EmbedBuilder()
					...
					.addFields({
						...
						value: `Create queues by typing ${commandMention("members", "add")}. You can create as many queues as you want.`,
					},
					{
						name: "2. Add Members",
					...
					{
						name: "\u200b",
						value: "[Consider supporting the bot 💖](https://www.buymeacoffee.com/Arroww)",
					}),
			],
		});
	}
