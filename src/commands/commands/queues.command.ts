...
export class QueuesCommand extends AdminCommand {
	...
	static readonly ADD_OPTIONS = {
		name: new NameOption({ required: true, description: "Queue name" }),
		...
		lockToggle: new LockToggleOption({ description: "Lock toggle (prevents joining)" }),
		...
		pullMessageChannel: new PullMessageChannelOption({ description: "Pull message channel (public type only)" }),
		rejoinCooldownPeriod: new RejoinCooldownPeriodOption({ description: "Rejoin cooldown after pull (s)" }),
		rejoinGracePeriod: new RejoinGracePeriodOption({ description: "Rejoin grace after leave (s)" }),
		...
		voiceOnlyToggle: new VoiceOnlyToggleOption({ description: "Voice-only toggle (source VC required)" }),
	...
	static readonly SET_OPTIONS = {
		...
		lockToggle: new LockToggleOption({ description: "Lock toggle (prevents joining)" }),
		memberDisplayType: new MemberDisplayTypeOption({ description: "Member display type" }),
		name: new NameOption({ description: "Queue name" }),
		pullBatchSize: new PullBatchSizeOption({ description: "Pull batch size" }),
		pullMessage: new PullMessageOption({ description: "Pull message" }),
		pullMessageDisplayType: new PullMessageDisplayTypeOption({ description: "Pull message display type" }),
		pullMessageChannel: new PullMessageChannelOption({ description: "Pull message channel (public type only)" }),
	...
	static async queues_delete(inter: SlashInteraction) {
		...
		await QueueUtils.deleteQueue(inter.store, queue.id);
